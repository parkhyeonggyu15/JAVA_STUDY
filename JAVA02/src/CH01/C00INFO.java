...
public class C00INFO {
	...
	public static void main(String[] args) {
		...
		//1. 객체란(OBJECT)?
		// 존재(독점적이고 배타적인 공간(VOLUMN)을 차지) 사물(OBJECT)
		...
		// 2) 클래스(==메소드)영역	: 공유메모리 영역(생성자,일반메서드,static메서드,static변수)
		// 3) 힙영역				: 객체 저장 영역(new 예약어 사용시 할당)
		
		// Scanner sc = 1)new 2)Scanner(System.in);
		// public class Ex00{
		// public static void main(String [] args)
		// {
		...
		// new Scanner(System,in)	: 생성자 함수 호출(객체 생성에 필요한 초기값 부여,size전달)
