...
public class C07ParkingDto {
	...
	public C07ParkingDto() {
		super();
	}

	public C07ParkingDto(String 위반구분, String 위반일시, String 위반장소, String 과태료부과일자, String 데이터기준일자) {
		super();
		this.위반구분 = 위반구분;
		this.위반일시 = 위반일시;
		this.위반장소 = 위반장소;
	...
	public String toString() {
		return "C07ParkingDto [위반구분=" + 위반구분 + ", 위반일시=" + 위반일시 + ", 위반장소=" + 위반장소 + ", 과태료부과일자=" + 과태료부과일자
				+ ", 데이터기준일자=" + 데이터기준일자 + "]";
	}
