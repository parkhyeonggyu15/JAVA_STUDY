...
//		double(8byte)
		...
		int num2 = 4;				//	4라는 값(리터럴상수)을 상수POOL저장, 4byte 정수공간 num2 초기화
		int num3 = num1 + num2;		//	num1안의값과 num2안의값의 덧셈결과(CPU가산처리)를 4byte 정수공간 num3에 초기화
		System.out.println(num3);	//	num3안의 값을 println매서드로 전달해서 내부적으로 표준출력 처리
